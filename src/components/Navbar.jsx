...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#7e3431] text-gray-300">
      <div>
      </div>
      ...
      <ul
        className={
          !nav
            ? "hidden"
            : "absolute top-0 left-0 w-full h-screen bg-[#7e3431] flex flex-col justify-center items-center"
        }
      >
