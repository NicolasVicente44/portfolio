...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#7e3431]  flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/0d9f6adb-6c59-4ee6-a292-cde55b87e166" className='flex flex-col max-w-[600px] w-full'>
            ...
            <button className='text-white border-2 hover:bg-[#000000] hover:border-white px-4 py-3 my-9 mx-auto flex items-center'>Lets Connect</button>
        </form>
    </div>
  )
}
